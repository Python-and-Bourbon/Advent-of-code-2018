...
#stops moving carts when there's only 1 left
while len(carts) > 1:
    ...
    for cart in carts:
        ...
        if (r2,c2) in [(other.r, other.c) for other in carts]:
            #remove the crashed carts from the lists
            carts = [other for other in carts if (other.r, other.c) not in [(cart.r, cart.c),(r2,c2)]]
